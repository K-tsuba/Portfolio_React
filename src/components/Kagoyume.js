          ...
          <div className='work-width'>
            <div className='row'>
              ...
              <div className='mt-5'>
                ...
                <p style={{ 'font-size': '18px' }}>DAOやDTO, Beanを使用してコードを設計した</p>
              ...
              <div className='my-5'>
                ...
                <p style={{ 'font-size': '18px' }}>yahooのapiと連携してデータを取得すること</p>
                ...
                <p style={{ 'font-size': '18px' }}>商品かごの中身をそれぞれのユーザーごとの中身にすること</p>
